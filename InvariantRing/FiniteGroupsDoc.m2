...
document {
    ...
    Outputs => {
        ...
        EXAMPLE {
            "L = {{2,1},{1,2,4,5,3}}",
            "P = permutationAction(L, Variable=>\"α\")",
            },
    
        PARA {
            "The generating permutations can also be expressed as products of cycles
            by setting the option ", TT "EntryMode=>\"cycle\"", ".
            In this case, the ring must be passed by the user. The next example
            constructs the permutation action generated by two permutations:
            a product of a 2-cycle and a 3-cycle, and a 4-cycle."
            },
